...
class RigUI(bpy.types.Panel):
    ...
    def draw(self, context):
        ...
        if is_selected({'hand_ik.L', 'hand_fk.L', 'upper_arm_ik_target.L', 'forearm_fk.L', 'upper_arm_tweak.L', 'upper_arm_tweak.L.001', 'upper_arm_fk.L', 'upper_arm_parent.L', 'hand_tweak.L', 'upper_arm_ik.L', 'VIS_upper_arm_ik_pole.L', 'forearm_tweak.L.001', 'forearm_tweak.L'}):
            emit_rig_separator()
            if is_selected({'forearm_fk.L', 'upper_arm_parent.L', 'upper_arm_fk.L', 'hand_fk.L'}):
            ...
            props = group1.operator('pose.rigify_generic_snap_megpu0rkfe1e8826', text='FK->IK (hand.L)', icon='SNAP_ON')
            ...
            props = group2.operator('pose.rigify_generic_snap_bake_megpu0rkfe1e8826', text='Action', icon='ACTION_TWEAK')
            props.output_bones = '["upper_arm_fk.L", "forearm_fk.L", "hand_fk.L"]'
            props.input_bones = '["upper_arm_ik.L", "MCH-forearm_ik.L", "MCH-upper_arm_ik_target.L"]'
            props.ctrl_bones = '["upper_arm_ik.L", "upper_arm_ik_target.L", "hand_ik.L"]'
            props = group2.operator('pose.rigify_clear_keyframes_megpu0rkfe1e8826', text='Clear', icon='CANCEL')
            props.bones = '["upper_arm_fk.L", "forearm_fk.L", "hand_fk.L"]'
            group1 = layout.column(align=True)
            props = group1.operator('pose.rigify_limb_ik2fk_megpu0rkfe1e8826', text='IK->FK (hand.L)', icon='SNAP_ON')
            ...
            props.extra_ctrls = '[]'
            group2 = group1.row(align=True)
            props = group2.operator('pose.rigify_limb_ik2fk_bake_megpu0rkfe1e8826', text='Action', icon='ACTION_TWEAK')
            props.prop_bone = 'upper_arm_parent.L'
            props.fk_bones = '["upper_arm_fk.L", "forearm_fk.L", "hand_fk.L"]'
            props.ik_bones = '["upper_arm_ik.L", "MCH-forearm_ik.L", "MCH-upper_arm_ik_target.L"]'
            props.ctrl_bones = '["upper_arm_ik.L", "upper_arm_ik_target.L", "hand_ik.L"]'
            ...
            if is_selected({'upper_arm_ik_target.L', 'upper_arm_ik.L', 'upper_arm_parent.L', 'hand_ik.L'}):
                ...
                props = group2.operator('pose.rigify_limb_toggle_pole_megpu0rkfe1e8826', icon='FORCE_MAGNETIC')
                props.prop_bone = 'upper_arm_parent.L'
                props.ik_bones = '["upper_arm_ik.L", "MCH-forearm_ik.L", "MCH-upper_arm_ik_target.L"]'
                props.ctrl_bones = '["upper_arm_ik.L", "upper_arm_ik_target.L", "hand_ik.L"]'
                props.extra_ctrls = '[]'
                group2.prop(pose_bones['upper_arm_parent.L'], '["pole_vector"]', text='')
                props = group1.operator('pose.rigify_limb_toggle_pole_bake_megpu0rkfe1e8826', text='', icon='ACTION_TWEAK')
                props.prop_bone = 'upper_arm_parent.L'
                props.ik_bones = '["upper_arm_ik.L", "MCH-forearm_ik.L", "MCH-upper_arm_ik_target.L"]'
                props.ctrl_bones = '["upper_arm_ik.L", "upper_arm_ik_target.L", "hand_ik.L"]'
                props.extra_ctrls = '[]'
                group1 = layout.row(align=True)
                group2 = group1.split(factor=0.75, align=True)
                props = group2.operator('pose.rigify_switch_parent_megpu0rkfe1e8826', text='IK Parent', icon='DOWNARROW_HLT')
                ...
                props = group1.operator('pose.rigify_switch_parent_bake_megpu0rkfe1e8826', text='', icon='ACTION_TWEAK')
                props.bone = 'hand_ik.L'
                props.prop_bone = 'upper_arm_parent.L'
                props.prop_id = 'IK_parent'
                props.parent_names = '["None", "Root", "Torso", "Hips", "Chest", "Head", "shoulder.L"]'
                ...
                group1 = layout.row(align=True)
                group2 = group1.split(factor=0.75, align=True)
                props = group2.operator('pose.rigify_switch_parent_megpu0rkfe1e8826', text='Pole Parent', icon='DOWNARROW_HLT')
        ...
        if is_selected({'f_index.02.L', 'f_index.01_master.L', 'f_index.01.L', 'f_index.01.L.001', 'f_index.03.L'}):
            emit_rig_separator()
            layout.prop(pose_bones['f_index.01_master.L'], '["finger_curve"]', text='Curvature', slider=True)

        if is_selected({'thumb.01.L.001', 'thumb.01_master.L', 'thumb.01.L', 'thumb.03.L', 'thumb.02.L'}):
            emit_rig_separator()
            layout.prop(pose_bones['thumb.01_master.L'], '["finger_curve"]', text='Curvature', slider=True)

        if is_selected({'f_middle.03.L', 'f_middle.01.L', 'f_middle.01.L.001', 'f_middle.02.L', 'f_middle.01_master.L'}):
            emit_rig_separator()
            layout.prop(pose_bones['f_middle.01_master.L'], '["finger_curve"]', text='Curvature', slider=True)

        if is_selected({'f_ring.01.L.001', 'f_ring.02.L', 'f_ring.03.L', 'f_ring.01_master.L', 'f_ring.01.L'}):
            emit_rig_separator()
            layout.prop(pose_bones['f_ring.01_master.L'], '["finger_curve"]', text='Curvature', slider=True)

        if is_selected({'f_pinky.02.L', 'f_pinky.01.L', 'f_pinky.01.L.001', 'f_pinky.03.L', 'f_pinky.01_master.L'}):
            emit_rig_separator()
            layout.prop(pose_bones['f_pinky.01_master.L'], '["finger_curve"]', text='Curvature', slider=True)

        if is_selected({'upper_arm_tweak.R.001', 'upper_arm_tweak.R', 'forearm_fk.R', 'upper_arm_ik_target.R', 'hand_tweak.R', 'hand_ik.R', 'upper_arm_parent.R', 'hand_fk.R', 'forearm_tweak.R.001', 'upper_arm_ik.R', 'VIS_upper_arm_ik_pole.R', 'forearm_tweak.R', 'upper_arm_fk.R'}):
            emit_rig_separator()
            if is_selected({'hand_fk.R', 'upper_arm_parent.R', 'forearm_fk.R', 'upper_arm_fk.R'}):
            ...
            group1 = layout.column(align=True)
            props = group1.operator('pose.rigify_generic_snap_megpu0rkfe1e8826', text='FK->IK (hand.R)', icon='SNAP_ON')
            ...
            group1 = layout.column(align=True)
            props = group1.operator('pose.rigify_limb_ik2fk_megpu0rkfe1e8826', text='IK->FK (hand.R)', icon='SNAP_ON')
        ...
        if is_selected({'f_index.02.R', 'f_index.01.R', 'f_index.01_master.R', 'f_index.01.R.001', 'f_index.03.R'}):
            emit_rig_separator()
            layout.prop(pose_bones['f_index.01_master.R'], '["finger_curve"]', text='Curvature', slider=True)

        if is_selected({'thumb.01.R.001', 'thumb.02.R', 'thumb.01_master.R', 'thumb.01.R', 'thumb.03.R'}):
            emit_rig_separator()
            layout.prop(pose_bones['thumb.01_master.R'], '["finger_curve"]', text='Curvature', slider=True)

        if is_selected({'f_middle.01.R.001', 'f_middle.02.R', 'f_middle.01_master.R', 'f_middle.01.R', 'f_middle.03.R'}):
            emit_rig_separator()
            layout.prop(pose_bones['f_middle.01_master.R'], '["finger_curve"]', text='Curvature', slider=True)

        if is_selected({'f_ring.01_master.R', 'f_ring.01.R', 'f_ring.01.R.001', 'f_ring.02.R', 'f_ring.03.R'}):
            emit_rig_separator()
            layout.prop(pose_bones['f_ring.01_master.R'], '["finger_curve"]', text='Curvature', slider=True)

        if is_selected({'f_pinky.01.R.001', 'f_pinky.02.R', 'f_pinky.01.R', 'f_pinky.03.R', 'f_pinky.01_master.R'}):
            emit_rig_separator()
            layout.prop(pose_bones['f_pinky.01_master.R'], '["finger_curve"]', text='Curvature', slider=True)

        if is_selected({'spine_fk.001', 'chest', 'spine_fk.002', 'spine_fk', 'tweak_spine.002', 'tweak_spine', 'tweak_spine.003', 'torso', 'tweak_spine.001', 'neck', 'hips', 'tweak_spine.004', 'tweak_spine.005', 'spine_fk.003', 'head'}):
            emit_rig_separator()
            ...
            if is_selected({'spine_fk.001', 'spine_fk.002', 'chest', 'spine_fk', 'tweak_spine.002', 'tweak_spine', 'tweak_spine.003', 'torso', 'tweak_spine.001', 'hips', 'tweak_spine.004', 'spine_fk.003'}):
                group1 = layout.row(align=True)
                group2 = group1.split(factor=0.75, align=True)
                props = group2.operator('pose.rigify_switch_parent_megpu0rkfe1e8826', text='Torso Parent', icon='DOWNARROW_HLT')
                props.bone = 'torso'
        ...
        if is_selected({'lid.B.L', 'lid.T.L.002', 'lid.T.L.003', 'eye.R', 'lid.B.L.003', 'lid.B.L.001', 'eye.L', 'lid.T.L', 'eye_master.R', 'lid.T.L.001', 'lid.B.L.002', 'eye_common', 'eye_master.L'}):
            emit_rig_separator()
            ...
            if is_selected({'lid.B.L', 'lid.T.L.002', 'lid.T.L.003', 'lid.B.L.003', 'lid.B.L.001', 'eye.L', 'lid.T.L', 'lid.T.L.001', 'lid.B.L.002', 'eye_master.L'}):
                layout.prop(pose_bones['eye.L'], '["lid_follow"]', text='Eyelids Follow', slider=True)
            if is_selected({'eye.R', 'eye_common', 'eye.L', 'eye_master.R', 'eye_master.L'}):
                group1 = layout.row(align=True)
                group2 = group1.split(factor=0.75, align=True)
                props = group2.operator('pose.rigify_switch_parent_megpu0rkfe1e8826', text='Parent (eye_common)', icon='DOWNARROW_HLT')
        ...
        if is_selected({'eye.R', 'lid.T.R.001', 'lid.T.R', 'eye_master.R', 'lid.B.R', 'lid.B.R.003', 'lid.B.R.001', 'lid.T.R.003', 'lid.B.R.002', 'lid.T.R.002'}):
            emit_rig_separator()
        ...
        if is_selected({'foot_fk.L', 'foot_ik.L', 'shin_tweak.L.001', 'foot_heel_ik.L', 'shin_tweak.L', 'thigh_fk.L', 'shin_fk.L', 'VIS_thigh_ik_pole.L', 'toe_ik.L', 'thigh_tweak.L', 'thigh_ik_target.L', 'foot_spin_ik.L', 'foot_tweak.L', 'toe_fk.L', 'thigh_ik.L', 'thigh_parent.L', 'thigh_tweak.L.001'}):
            emit_rig_separator()
            if is_selected({'foot_fk.L', 'toe_fk.L', 'thigh_parent.L', 'thigh_fk.L', 'shin_fk.L'}):
            ...
            group1 = layout.column(align=True)
            props = group1.operator('pose.rigify_generic_snap_megpu0rkfe1e8826', text='FK->IK (foot.L)', icon='SNAP_ON')
            ...
            group1 = layout.column(align=True)
            props = group1.operator('pose.rigify_limb_ik2fk_megpu0rkfe1e8826', text='IK->FK (foot.L)', icon='SNAP_ON')
            ...
            if is_selected({'toe_ik.L', 'foot_heel_ik.L', 'thigh_ik.L', 'foot_ik.L', 'foot_spin_ik.L', 'thigh_ik_target.L', 'thigh_parent.L'}):
        ...
        if is_selected({'foot_tweak.R', 'thigh_fk.R', 'thigh_parent.R', 'VIS_thigh_ik_pole.R', 'foot_spin_ik.R', 'foot_heel_ik.R', 'toe_ik.R', 'thigh_ik.R', 'thigh_tweak.R.001', 'toe_fk.R', 'foot_ik.R', 'thigh_tweak.R', 'foot_fk.R', 'shin_tweak.R', 'shin_fk.R', 'shin_tweak.R.001', 'thigh_ik_target.R'}):
            emit_rig_separator()
            ...
            group1 = layout.column(align=True)
            props = group1.operator('pose.rigify_generic_snap_megpu0rkfe1e8826', text='FK->IK (foot.R)', icon='SNAP_ON')
            ...
            group1 = layout.column(align=True)
            props = group1.operator('pose.rigify_limb_ik2fk_megpu0rkfe1e8826', text='IK->FK (foot.R)', icon='SNAP_ON')
            ...
            if is_selected({'thigh_ik_target.R', 'foot_heel_ik.R', 'toe_ik.R', 'thigh_ik.R', 'thigh_parent.R', 'foot_ik.R', 'foot_spin_ik.R'}):
